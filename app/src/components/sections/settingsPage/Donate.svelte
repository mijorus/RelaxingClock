...
<SettingsBox collapsable={false} unsupported={protip === null}>
    ...
    <PrimaryBox
        label={{ text: "Buy me a kofi" }}
        description={{ text: "If you like Relaxing Clock, please consider a small donation. Thank you!", iconClass: "lnr lnr-question-circle" }}
        available={true}
    >
        <Action label="Open" on:click={() => window.open("https://ko-fi.com/mijorus")} />
    </PrimaryBox>
</SettingsBox>
