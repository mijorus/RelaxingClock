...
<h2 class="relative flex justify-center items-center md:block">
    <slot></slot>
    <span class="flex items-center max-h-96 text-3xl md:text-4xl text-primary cursor-pointer font-primary font-bold settings-box-element-title whitespace-nowrap overflow-ellipsis" 
